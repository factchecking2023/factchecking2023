...
class Tokenizer(TextEncoder):
    ...
    def decode(self, encoded):
        # return self.tokenizer.decode(encoded.squeeze(), skip_special_tokens=True)
        return self.tokenizer.convert_ids_to_tokens(encoded.squeeze(), skip_special_tokens=False)
